  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
        ...
        Positioned(bottom: 0, left: 22, right: 22, child: _QuickActionsRow()),
      ],
    );
  }
}
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    GestureDetector(
                      onTap: () =>
                          showAppToast(context, 'Sin notificaciones nuevas'),
                      child: Container(
                        width: 38,
                        height: 38,
                        decoration: BoxDecoration(
                  ...
                  child: Row(
                    children: [
                      ...
                      if (vm.query.isNotEmpty)
                        GestureDetector(
                          onTap: () =>
                              context.read<HomeViewModel>().setQuery(''),
                          child: const Icon(
                            Icons.close_rounded,
                            color: AppColors.slateL,
                            size: 18,
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: GridView.builder(
        ...
        itemBuilder: (ctx, i) =>
            DocCard(doc: docs[i], onTap: () => _openDoc(ctx, docs[i])),
      ),
    );
  }
